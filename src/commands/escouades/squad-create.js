        ...
        if (this.ctx.isResp(choice, "y")) {
            ...
            if (pDatas.squad !== null) {
                return await this.ctx.reply(
                    "Oups...",
                    "Il semblerait que vous fassiez déjà parti d'une escouade.",
                    null,
                    null,
                    "warning",
                );
            ...
            if (playerLevel.level < 20) {
                return await this.ctx.reply(
                    "Oups...",
                    "Créer une escouade nécessite d'être niveau **20**. Revenez me voir lorsque ça sera le cas.",
                    null,
                    null,
                    "warning",
                );
            ...
            if (iDatas.yens < 10_000) {
                return await this.ctx.reply(
                    "Oups...",
                    `Vous devez récolter **10'000¥** pour créer une escouade.\n\nSolde actuel: **${iDatas.yens}**`,
                    null,
                    null,
                    "warning",
                );
            ...
            return await this.ctx.reply(
                ...
                `Votre escouade **${newSquad.name}** a bien été créée ! `
                +
                "Vous pouvez obtenir des informations dessus en faisant la commande squad.",
                "🥳",
                null,
                "outline",
            );
            ...
            return await this.ctx.reply(
                "Créer votre escouade.",
                "Vous avez décidé de ne pas créer d'escouade.",
                "⛩️",
                null,
                "outline",
            );
