        ...
        if (this.ctx.isResp(choice, "y")) {
            ...
            if (pDatas.squad.owner !== this.message.author.id) {
                return await this.ctx.reply(
                    "Oups...",
                    "Seul les chefs d'escouade peuvent promouvoir des gens.",
                    null,
                    null,
                    "warning",
                );
            ...
            if (!uExists) {
                return await this.ctx.reply(
                    "Oups...",
                    "Le profil du joueur à promouvoir est introuvable.",
                    null,
                    null,
                    "warning",
                );
            }
            if (!pDatas.squad.members.includes(user.id)) {
                return await this.ctx.reply(
                    "Oups...",
                    "Ce joueur ne se trouve pas dans votre escouade.",
                    null,
                    null,
                    "warning",
                );
            }
            if (pDatas.squad.right_hand === user.id) {
                return await this.ctx.reply(
                    "Oups...",
                    "Ce joueur est déjà le bras droit de l'escouade.",
                    null,
                    null,
                    "warning",
                );
            ...
            return await this.ctx.reply(
                "Promotion d'un joueur de l'escouade.",
                "Le joueur a été promu bras droit de l'escouade.",
                "⛩️",
                null,
                "outline",
            );
            ...
            return await this.ctx.reply(
                "Promotion d'un joueur de l'escouade.",
                "Le joueur n'a pas été promo bras droit de l'escouade.",
                "⛩️",
                null,
                "outline",
            );
