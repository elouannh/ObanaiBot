        ...
        if (this.ctx.isResp(choice, "y")) {
            ...
            if (pDatas.squad.owner !== this.message.author.id) {
                return await this.ctx.reply(
                    "Oups...",
                    "Seul les chefs d'escouade peuvent exclure des gens.",
                    null,
                    null,
                    "warning",
                );
            ...
            if (!uExists) {
                return await this.ctx.reply(
                    "Oups...",
                    "Le profil du joueur à exclure est introuvable.",
                    null,
                    null,
                    "warning",
                );
            ...
            return await this.ctx.reply(
                "Exclusion d'un joueur de l'escouade.",
                "Le joueur a été exclu de l'escouade.",
                "⛩️",
                null,
                "outline",
            );
            ...
            return await this.ctx.reply(
                "Exclusion d'un joueur de l'escouade.",
                "Le joueur n'a pas été exclu de l'escouade.",
                "⛩️",
                null,
                "outline",
            );
