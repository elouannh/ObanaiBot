...
class GrimoireUnset extends Command {
    ...
    async run() {
        ...
        const msg = await this.ctx.reply(
            "Retirer un grimoire.",
            "Voulez-vous retirer votre grimoire actif ? Les effets appliqués dessus disparaitront."
            +
            " Vous gagnerez quelques yens de compensation."
            +
        ...
        if (this.ctx.isResp(choice, "y")) {
            ...
            if (pDatas.active_grimoire === null) {
                return await this.ctx.reply(
                    "Oups...",
                    "Il semblerait qu'il n'y ait pas de grimoire actif sur votre inventaire.",
                    null,
                    null,
                    "warning",
                );
            ...
            return await this.ctx.reply(
                "Retirer un grimoire.",
                `Vous avez donc retiré **${grimDatas.name}**.`,
                "📖",
                null,
                "outline",
            );
            ...
            return await this.ctx.reply(
                "Retirer un grimoire.",
                "Vous avez donc décidé de ne pas retirer votre grimoire.",
                "📖",
                null,
                "outline",
            );
