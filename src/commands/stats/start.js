...
class Start extends Command {
    ...
    async run() {
        ...
        if (this.ctx.isResp(choice, "y")) {
            ...
            return await this.ctx.reply("Bienvenue jeune joueur !", "Vous êtes désormais un joueur Obanai. Vous pouvez voir la liste des commandes à tout moment avec la commande help.", "🎉", null, "outline");
        }
            ...
            return await this.ctx.reply("Commencer votre aventure.", "La commande n'a pas aboutie. Soit vous avez mis trop de temps à répondre, soit vous n'avez pas répondu comme convenu.", null, null, "timeout");
        }
    }
}
