module.exports = () => {
    ...
    const quotes = [
        ...
        "Soyez reconnaissant pour le sang… Vous n’êtes pas autorisé à répandre ne serait-ce qu’une seule goutte sur le sol… car si vous le faites… "
            +
            "votre torse et votre tête se sépareront douloureusement.",
        ...
        "Peu importe le nombre de personnes que vous pourriez perdre, vous n’avez pas d’autre choix que de continuer à vivre."
            +
            " Peu importe à quel point les coups sont dévastateurs.",
        "Ceux qui ont regretté leurs propres actions, Je ne les piétinerais jamais. Parce que les démons étaient autrefois humains aussi."
            +
            " Tout comme moi, ils étaient humains aussi.",
        ...
        "Est-ce que mon teint vous paraît terrible ? Mon visage vous paraît-il pâle ? Ai-je l’air faible pour vous ? On dirait que je n’ai pas longtemps à vivre ?"
            +
            " Est-ce que je suis proche de la mort ?",
